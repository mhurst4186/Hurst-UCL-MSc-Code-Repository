...
strat = [-1e-3, -1e-2, -1e-1, -1e0, -1e1, -1e2, -3e2, -5e2, -7.5e2, -1e3];
names = {'Strat1e-3','Strat1e-2','Strat1e-1','Strat1e0','Strat1e1','Strat1e2','Strat3e2','Strat5e2','Strat7_5e2','Strat1e3'};

maindirectory = '../../../ServerCode/10_speed_vs_strat_sc100/Results/';
...
title('Steady Speed vs. Stratification (Sc = 100)')
saveas(f1,[maindirectory 'speed_vs_strat_dim'],'epsc')
...
title('Steady Speed (nondimensional) vs. Stratification (Sc = 100)')
saveas(f2,[maindirectory 'speed_vs_strat_nondim'],'epsc')