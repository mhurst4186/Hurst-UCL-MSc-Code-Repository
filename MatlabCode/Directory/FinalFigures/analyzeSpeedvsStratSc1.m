...
strat = [-1e-3, -1e-2, -1e-1, -1e0, -1e1];
names = {'Strat1e-3','Strat1e-2','Strat1e-1','Strat1e0','Strat1e1'};

maindirectory = '../../../ServerCode/05_speed_vs_strat_sc1/Results/';
...
title('Steady Speed vs. Stratification (Sc = 1)')
...
title('Steady Speed (nondimensional) vs. Stratification (Sc = 1)')
