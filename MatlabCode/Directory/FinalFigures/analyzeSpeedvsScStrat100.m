...
Sc = [100 500 1000 1500 2000 2500 3000];
names = {'Sc100','Sc500','Sc1000','Sc1500','Sc2000','Sc2500','Sc3000'};
maindirectory = '../../../ServerCode/08_speed_vs_sc_strat100/Results/';
...
title('Steady Speed vs. Schmidt Number ($\partial\rho / \partial z = -100$ [kg m$^{-4}$])')
...
title('Steady Speed (non-dimensional) vs. Schmidt Number ($\partial\rho / \partial z = -100$ [kg m$^{-4}$])')
